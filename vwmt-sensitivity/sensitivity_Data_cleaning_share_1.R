# Only include 76 who has stardard sessions/training but no further exclusion regarding the pre-registered exclusion cteria
...
print('OVERAL, we do not exlcude the pre-registered screening for sensitivity analysis: ')
# print(toExclude)
print('...in which ....')
...
print('Any Missing during traiing:')
print(missingOveral)
print('Who has been considered being excluded according to pre-registered exclusion criteria:')
print(excluddedList)
